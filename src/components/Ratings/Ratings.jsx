      ...
      <div className="border-t border-gray-200 py-4">
        ...
        <div className="my-3">
          ...
          <div className="text-sm text-gray-400 py-2">
            Rabiu stores is my one stop shop for everything. I never knew I
            could easily have access to farm produce easily but since I joined
            Japtini I stand corrected. The vendors, especially Rabiu stores ave
            been properly vetted and it’s impressive.
          </div>
        </div>
        <div className="my-3">
          <div>
