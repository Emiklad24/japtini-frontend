      ...
      <div className="max-w-6xl mx-auto py-5 px-4 md:px-0">
        <div className="block md:flex gap-0">
          <div className="md:px-0 px-4 w-full md:w-2/5">
            <img src="../img/corn.png" alt="" className="mx-auto" />
          </div>
          <div className="border-b border-gray-100 md:px-0 px-4 w-full md:w-2/5">
            <div>
              <div className="text-2xl font-bold ">King's Vegetable Oil</div>
              ...
              <div className="font-medium text-2xl my-3">₦50,000.00</div>
              <div className="flex gap-3 w-3/4 my-7">
                ...
                <div className="w-1/2">
                  <button className="rounded p-3 text-xs text-white capitalize bg-jp-purple-100 font-medium w-full flex items-center gap-3 justify-center">
                    Add to Cart
                    <svg
                      className="w-3"
                      width={20}
          ...
          <div className="border-b border-gray-100 md:px-0 px-4 w-full md:w-1/5">
            <div>
              ...
              <div className="flex items-center text-ll leading-6 gap-3">
                ...
                Order Fulfillment:<span className="font-medium">Excellent</span>
              </div>
              <div className="flex items-center text-ll leading-6 gap-3">
                <svg
                  className="w-4"
    ...
    "
        ...
        <div className="tab-content" id="tabs-tabContent">
          ...
          >
            ...
            preparation/cooking of delight-some meals and salads. By using Devon
            King's cooking oil at home or in your catering and hospitality
            establishment, you can be sure to provide nourishing and masterfully
            created tasty meals.
          </div>
          <div
            ...
            <div className="border-t border-gray-200 py-4">
              ...
              <div className="my-3">
                ...
                <div className="text-sm text-gray-400 py-2">
                  Rabiu stores is my one stop shop for everything. I never knew
                  I could easily have access to farm produce easily but since I
                  joined Japtini I stand corrected. The vendors, especially
                  Rabiu stores ave been properly vetted and it’s impressive.
                </div>
              </div>
              <div className="my-3">
                <div>
